...
tolerance. Their scale floors are based on the existing initial Stokes
residual convention and the current surface-Jacobian action, using
$\max(\epsilon_{\rm linear},\sqrt{\epsilon_{\rm mach}})$ rather than a new
dimensional parameter. If a block and its reference scale are exactly zero,
