...
The physical phase field at every sample must be finite and lie in $[0,1]$.
A tail value $\phi=0$ is admissible. The independent constitutive condition is
$\bar g>0$; $\bar g=0$, including a possible $\phi=1$ singularity, shall be
reported explicitly as an $I_h$ singularity and shall not be classified as a
phase-field range violation.
