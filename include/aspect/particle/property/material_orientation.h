...
#ifndef _aspect_particle_property_material_orientation_h
#define _aspect_particle_property_material_orientation_h
...
namespace aspect
{
  namespace Particle
  {
    ...
    {
      /**
       * A class that calculates the material orientation of a particle.
       *
       * @ingroup ParticleProperties
       */
      template <int dim>
      class MaterialOrientation : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
